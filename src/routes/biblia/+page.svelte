...
<body>
  ...
  <main class="container">
    <h1>Teste de API para acessar a Bíblia</h1>
    ...
    {:catch error}
      <div class="error">
        Acesso aos dados não disponíveis no momento. Tente novamente, mais
        tarde.
        <p>{error}</p>
      </div>
    {/await}
  ...
  <footer class="container">
    <small>
      Exemplo de uso: <i>/biblia?verso=1 Coríntios 13:4-7</i>
    </small>
  </footer>
</body>
